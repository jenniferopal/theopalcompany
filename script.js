...
Webflow.define('slider', module.exports = function ($, _) {
  ...
  function layout(data) {
    ...
    var anchor = 0;
    var width = 0;
    var maskWidth = data.maskWidth;ßßß
